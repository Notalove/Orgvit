...
from mmseg.apis import multi_gpu_test, single_gpu_test, single_gpu_test_with_statis
...
def main():
    ...
    if not distributed:
        ...
        #outputs = single_gpu_test_with_statis(model, data_loader, args.show, args.show_dir, efficient_test)
